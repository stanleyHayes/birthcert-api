...
const createPayment = async (name, phone, transaction_id, amount) => {
    ...
    const payment = await Payment.create({name, phone, transaction_id, amount});
...
const updatePayment = async (id, update) => {
    ...
    const allowedUpdates = ['status', 'transaction_id', 'phone', 'name'];
